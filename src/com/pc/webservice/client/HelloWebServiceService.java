 ...
 * 
 */
@WebServiceClient(name = "HelloWebServiceService", targetNamespace = "http://server.webservice.pc.com/", wsdlLocation = "http://localhost:6166/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWEBSERVICESERVICE_QNAME = new QName("http://server.webservice.pc.com/", "HelloWebServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:6166/hello?wsdl");
    ...
    public HelloWebService getHelloWebServicePort() {
        return super.getPort(new QName("http://server.webservice.pc.com/", "HelloWebServicePort"), HelloWebService.class);
    }
    ...
    public HelloWebService getHelloWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.webservice.pc.com/", "HelloWebServicePort"), HelloWebService.class, features);
    }
